...
export default class standardPage {
   ...
   //  standardPage
    async verifyEventManagementModule(){
        const ele = await this.page.locator(this.standardPage_Elements.EventManagement)
        try {
    ...
    async verifyClientsModule(){
        const ele = await this.page.locator(this.standardPage_Elements.clients)
        try {
    ...
    async verifyVendorModule(){
        const ele = await this.page.locator(this.standardPage_Elements.vendor)
        try {
    ...
    async verifyUserManagementModule(){
        const ele = await this.page.locator(this.standardPage_Elements.usermanagement)
        try {
    ...
    async verifyEventsSubModule(){
        const ele = await this.page.locator(this.standardPage_Elements.Events)
        try {
            await expect.soft(ele).toContainText("User Management")
        } catch (error) {
    ...
    async verifyEventsListText(){
        const ele = await this.page.locator(this.standardPage_Elements.EventsListText)
        try {
    ...
    async verifyCompanySubmodule(){
        const ele = await this.page.locator(this.standardPage_Elements.Company)
        try {
    ...
    async verifyCompanyAccountList(){
        const ele = await this.page.locator(this.standardPage_Elements.CompanyList)
        try {
    ...
    async verifyEmployeeUserSubmodule(){
        const ele = await this.page.locator(this.standardPage_Elements.EmployeeUser)
        try {
    ...
    async verifyEmployeeListText(){
        const ele = await this.page.locator(this.standardPage_Elements.EmployeeUserList)
        try {
    ...
    async verifyBrokerSubmodule(){
        const ele = await this.page.locator(this.standardPage_Elements.Broker)
        try {
    ...
    async verifyBrokerListText(){
        const ele = await this.page.locator(this.standardPage_Elements.BrokerList)
        try {
            await ele.click()
            await this.page.waitForTimeout(2000)
        } catch (error) {
    ...
    async verifyvendorListText(){
        const ele = await this.page.locator(this.standardPage_Elements.VendorListText)
        try {
    ...
    async verifyAlignWellUserSubModule(){
        const ele = await this.page.locator(this.standardPage_Elements.Alignwelluser)
        try {
   ...
   async clickAlignWellUser(){
           const ele = this.page.locator(this.standardPage_Elements.Alignwelluser)
           try {
    ...
    async verifyUserList(){
        const ele = await this.page.locator(this.standardPage_Elements.UserList)
        try {
