...
test("Verify add events ",async({page,context,loginPage,eventsPage,registrationPage})=>{
   ...
   await eventsPage.inputEvent_Date()

   await eventsPage.upload_Event_ProfileImages() 
   ...
   await eventsPage.Select_Electricity_Yes()
...
//    await eventsPage.verifyVendorCategoryRequiredText()
   ...
   firstName = await eventsPage.generateFirstName()
   lastName = await eventsPage.generateLastName()
   await eventsPage.inputContactPesrsonName(`${firstName}${lastName}`)
   console.log(`${firstName}${lastName}`)
   await eventsPage.inputCompanyInsuranceProvider_Designation()
   await eventsPage.InputContactPerson_PhoneNumber_BD()
   await eventsPage.inputContactPesrsonEmail(`${firstName}${lastName}`)
   await eventsPage.checkedPPO()
   await eventsPage.checkedHMO()
//    await eventsPage.inputPPO()
//    await eventsPage.inputHMO()
   await eventsPage.ClickCompanyPreferedVendor_AddButton()
   await eventsPage.ClickNextButton()
   await eventsPage.verifyEventFourthPage()
   await eventsPage. Click_ChiropracticCoverage_Yes()
   await eventsPage.Click_AcupunctureCoverage_NO()
   await eventsPage.Click_PhysicalTherap_Yes()
   await eventsPage.Click_PodiatryCoverage_NO()
   await eventsPage.Click_OrthodontistCoverage_YES()
   await eventsPage.Click_MentalHealth_NO()
   await eventsPage.clickFinalSubmitt()
   await eventsPage.verifyEventAddedSuccessfully()
})